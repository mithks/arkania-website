...
function FooterLink({
  ...
  return (
    ...
    >
      <span className="transition-colors duration-300 group-hover:text-light">
        {children}
      </span>
...
export default function Footer() {
  return (
    <footer className="relative z-20 w-full bg-dark text-light isolate">
      <div className="max-w-[1700px] mx-auto px-6 md:px-8 py-20">
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-[20px] text-light/80">
          ...
          <div className="md:justify-self-end">
            <h4 className="text-[24px] font-semibold text-primary mb-6">
              Solutions
            </h4>
        ...
        {/* Divider */}
        <div className="my-16 h-px w-full bg-primary/40" />

        {/* Bottom */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-[18px] text-light/70">
